...
We also copy down the information of the dataset to the file Information.Rmd
...
We want to first look at how mission hours varies from person to person. We do that by using the no predictor hierarchical model as below:
